...
import { ErrorCodes, RpcError, type ChatMessage, type Session, type SessionMeta } from "@senastr/shared";
...
export class SessionStore {
  ...
  create(params: { title?: string; projectPath?: string | null } = {}): Session {
    const now = Date.now();
